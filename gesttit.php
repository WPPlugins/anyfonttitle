...
Plugin URI: http://javier.astycom.net
Description: Change the title of your Entries. In this version you can change the type, the size and the color of your titles. Please, read tue install instructions at wordpress repository.
...
global $gesttit_tam, $gesttit_ang, $gesttit_font, $gesttit_ini, $gesttit_col;
	$text = get_the_title();
	$gimg = '<img src="../wp-content/plugins/anyfonttitle/font_new2.php?text='.$text.'&tam='.$gesttit_tam.'&ang='.$gesttit_ang.'&font=font/'.$gesttit_font.'&ini='.$gesttit_ini.'&col='.$gesttit_col.'">';
	$content = $gimg;
	echo $content;
}
...
global 	$gesttit_tam, $gesttit_ang, $gesttit_ini, $gesttit_font, $gesttit_ver, $gesttit_font2, $gesttit_col;
...
echo "text test:<br>";
echo "<img src=\"../wp-content/plugins/anyfonttitle/font_new2.php?text=Lorem ipsun dolor&tam=$gesttit_tam&ang=$gesttit_ang&font=font/$gesttit_font&ini=$gesttit_ini&col=$gesttit_col\"><br>";
echo "your longest title:<br>";
$tml = muestraw();
echo "<img src=\"../wp-content/plugins/anyfonttitle/font_new2.php?text=$tml&tam=$gesttit_tam&ang=$gesttit_ang&font=font/$gesttit_font&ini=$gesttit_ini&col=$gesttit_col\"><br><br>";
